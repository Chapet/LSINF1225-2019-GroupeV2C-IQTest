...
public class see_my_mistakes_flash extends AppCompatActivity {
    ...
    private Button[] list = new Button[47];
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button41 = findViewById(R.id.rep41);
        button42 = findViewById(R.id.rep42);
        button43 = findViewById(R.id.rep43);
        button44 = findViewById(R.id.rep44);
        button45 = findViewById(R.id.rep45);
        button46 = findViewById(R.id.rep46);
        button47 = findViewById(R.id.rep47);
        list[0] = button1;
        list[1] = button2;
        list[2] = button3;
        list[3] = button4;
        ...
        for(int i = 0; i < list.length; i++){
            if(DatabaseHelper.getCorrect(i, 47)){
